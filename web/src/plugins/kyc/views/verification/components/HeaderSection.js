...
import { Editable as EditWrapper } from 'hollaex-web-lib';
import { sizeLimitInMB } from './Documents';
...
export const IdentificationFormSection = ({ strings: STRINGS }) => (
	<ChildrenContainer
		mainContent={
			<div className="header_title-content">
				...
				<ul className="header_title-list">
					<li>
						<EditWrapper stringId="USER_VERIFICATION.ID_DOCUMENTS_FORM.INFORMATION.ID_SECTION.LIST_ITEM_0">
							{
                STRINGS.formatString(STRINGS['USER_VERIFICATION.ID_DOCUMENTS_FORM.INFORMATION.ID_SECTION.LIST_ITEM_0'], sizeLimitInMB)
							}
						</EditWrapper>
					</li>
					<li>
              ...
              {
                STRINGS.formatString(STRINGS['USER_VERIFICATION.ID_DOCUMENTS_FORM.INFORMATION.ID_SECTION.LIST_ITEM_1'], sizeLimitInMB)
              }
						</EditWrapper>
					</li>
					<li>
...
export const PORSection = ({ strings: STRINGS }) => (
	<ChildrenContainer
		mainContent={
			<div>
				<div className="header_title-content">
...
export const SelfieWithPhotoId = ({ strings: STRINGS }) => (
	<ChildrenContainer
		mainContent={
			<div>
